...
rm -rf htmlcov/
docker exec -it dpg_api coverage run --omit='*/migrations/*.py,*__init__*,wsgi.py,manage.py,*apps.py,*adapter.py' --source='.' manage.py test authentication ext_news int_news
