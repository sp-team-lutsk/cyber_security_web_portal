...
urlpatterns = [
    ...
    path('users/list/', ListUserAPIView.as_view(), name='users'),            # all activated user list page
    ...
    path('users/', BulkUpdateAPIView.as_view(), name='bulk_update'),
    path('users/delete/', DeleteAllAPIView.as_view(), name='delete_all'),
    path('users/find/',FindUserAPIView.as_view(), name='user'),   # info about user by email search
    path('users/update/', UpdateUserAPIView.as_view(), name='update'),
